"""Configuration for the Olist Streamlit dashboard.
...
# streamlit/ -> p5_analytics/ -> m2-elt/ (repo root holds the .env.<env> files and secrets/).
...
# Offline / demo mode: serve from the baked parquet snapshot, never query BigQuery.
# Default ON so the live presentation never depends on auth/cost/network. Set
# DASH_OFFLINE=0 to query BigQuery live.
OFFLINE = os.environ.get("DASH_OFFLINE", "1") == "1"
